    ...
    <section id="kontak" className="container mx-auto px-4 py-16">
      ...
      <div className="flex flex-col md:flex-row gap-12 items-center"> 
        ...
        <div className="md:w-1/2 w-full h-80 rounded-2xl shadow-lg overflow-hidden">
          <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.3553912539096!2d106.99938543140885!3d-6.216776348306648!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698dfe693c0fa9%3A0x9a5a092583ca391!2sTK%2FRA%20AN-NAJM!5e0!3m2!1sid!2sid!4v1754145123755!5m2!1sid!2sid" 
            width="100%" 
            height="100%" 
            style={{ border: 0 }} 
            allowFullScreen="" 
